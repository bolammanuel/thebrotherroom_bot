...
<body>
    ...
    <section class="container hero">
        <div class="hero-content">
            ...
            <div class="hero-actions">
                ...
                <a href="https://wa.me/9097644444" target="_blank" class="btn btn-whatsapp" style="background-color: #25D366; color: #ffffff; border: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600; padding: 12px 24px; border-radius: 12px; text-decoration: none; transition: transform 0.2s, opacity 0.2s;">
    ...
    <section class="poll-section" id="poll">
        <div class="container poll-wrapper">
            <div class="poll-info">
                <h2>Active Learning Channels</h2>
                <p>The Brothers' Room is accessible across both <strong>Telegram</strong> and <strong>WhatsApp</strong>! Choose your preferred messaging platform below to start learning immediately, or register your contact details.</p>
                ...
                <div class="poll-stats">
                    ...
                    <div class="stat-row">
                        <div class="stat-header">
                            <span>WhatsApp Bot (SendPulse & Meta)</span>
                            <span style="color: #25d366; font-weight: 600;">85% LIVE</span>
                        </div>
                        <div class="stat-bar-bg">
                            <div class="stat-bar-fill" style="width: 85%; background-color: #25d366;"></div>
                        </div>
                    </div>
                </div>
            </div>
